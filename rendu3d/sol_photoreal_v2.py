...
# plinthe bois sombre au pied du mur (ancrage d'echelle)
plm = bpy.data.materials.new("plinthe"); plm.use_nodes = True
plm.node_tree.nodes["Principled BSDF"].inputs["Base Color"].default_value = (0.12, 0.09, 0.07, 1)
plm.node_tree.nodes["Principled BSDF"].inputs["Roughness"].default_value = 0.4
bpy.ops.mesh.primitive_cube_add(location=(0, 3.14, 0.045))
pl = bpy.context.object; pl.scale = (7, 0.012, 0.045); pl.data.materials.append(plm)
