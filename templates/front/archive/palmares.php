...
<section class="page-hero">
    ...
    <div class="container">
        <nav class="breadcrumb" aria-label="Fil d'Ariane">
            ...
            <span class="breadcrumb-sep"><?= icon('chevron-right', 14) ?></span>
            <span aria-current="page">Palmarès</span>
        </nav>

        <span class="page-hero-badge">
            <?= icon('award', 16) ?> Palmarès
        </span>

        <h1 class="page-hero-title">Palmarès du <em>Concours</em></h1>

        <p class="page-hero-intro">Résultats et classements par année et catégorie</p>
    </div>
</section>
    ...
    <div class="container">
        ...
        <?php if (empty($grouped)): ?>
            <div class="empty-state" style="text-align:center;padding:4rem 0">
                ...
                <p style="color:var(--brun)">Les résultats pour cette année ne sont pas encore publiés.</p>
            </div>
        <?php else: ?>
